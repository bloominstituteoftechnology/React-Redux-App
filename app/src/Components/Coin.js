...
const Coin = (props) => {
    ...
    useEffect(() => {
        ...
        setArrow(document.getElementById(props.coin.rank).classList.contains('hidden'))
    ...
    return (
        <div className='top-container'>
            ...
            {!props.isFetchingDetails && props.coinsDetails && <p>Price: ${JSON.stringify(props.coinsDetails.quotes.USD.price)}</p>} 
            </div>
        </div>
